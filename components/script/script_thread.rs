    ...
    pub(crate) fn navigate(
        ...
        with_script_thread(|script_thread| {
            ...
            if is_javascript {
                ...
                let Some(initiator_window) = script_thread
                    .documents
                    .borrow()
                    .find_window(initiator_pipeline_id)
                else {
                    warn!("Can't find global for navigation initiator");
                    return;
                };
                let Some(target_window) = script_thread
                    .documents
                    .borrow()
                    .find_window(target_pipeline_id)
                else {
                ...
                let task = task!(navigate_javascript: move |cx| {
                    ...
                    if target_global.is::<Window>() {
                        ...
                        if Self::navigate_to_javascript_url(cx, &initiator_global, &target_global, &mut load_data, None, initial_insertion) {
                            sender
                ...
                // TODO: use the right task source here (step 20.1)
                target_window
                    .as_global_scope()
                    .task_manager()
